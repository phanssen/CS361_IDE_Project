...
public class Main extends Application
{
    ...
    private static final String STAGE_TITLE =
            "Kyle Douglas, Paige Hanssen, Wyett MacDonald, and Tia Zhang's Project 9";
    ...
    public void start(Stage stage) throws Exception
    {
        ...
        scene.getStylesheets().add("/proj10DouglasHanssenMacDonaldZhang/css_styles/javaKeywords.css");
