...
import proj10DouglasHanssenMacDonaldZhang.Controllers.*;
...
public class Controller
{
    ...
    public void handleDarkMode(){
        handleThemeChange("proj10DouglasHanssenMacDonaldZhang/css_styles/DarkMode.css", darkModeMenuItem);
    }
    ...
    public void handleFunMode(){
        handleThemeChange("proj10DouglasHanssenMacDonaldZhang/css_styles/FunMode.css", funModeMenuItem);
    }
    ...
    public void handleHallowThemeMode(){
        handleThemeChange("proj10DouglasHanssenMacDonaldZhang/css_styles/HallowTheme.css", hallowThemeItem);
    }
    ...
    /**
     * Prompts the user to save if the current tab has not been
     * saved since the last change.
     * If the tab has never been saved, will automatically open
     * a FileChooser window to save the file.
